...
import {ArticleFeatureBlock} from "./ArticleFeatureBlock";
import {MainCandidate} from "./MainCandidate";
...
export class ArticleContent {
    ...
    @OneToOne(type=>Cp, cp_id=>cp_id.article_content,{  nullable:false,onDelete: 'CASCADE',onUpdate: 'CASCADE' })
